...
async def main():
    ...
    await WheelController.move_wheels_backward_in_straight_line(float(70), Speed.Slow)
    await WheelController.move_wheels_forward_in_straight_line(float(85), Speed.Slow)
    await WheelController.move_wheels_backward_in_straight_line(float(85), Speed.Slow)
